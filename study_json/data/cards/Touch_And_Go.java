...
public class Touch_And_Go extends CustomCard {
    ...
    public Touch_And_Go() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Touch_And_Go.png", 1, cardStrings.DESCRIPTION, CardType.ATTACK, AbstractCardEnum.Chtho_COLOR, CardRarity.COMMON, CardTarget.ENEMY);
        this.baseDamage = 7;
