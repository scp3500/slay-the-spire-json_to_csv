...
public class Spin_Destiny extends CustomCard {
    ...
    public Spin_Destiny() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Spin_Destiny.png", 1, cardStrings.DESCRIPTION, CardType.POWER, AbstractCardEnum.Chtho_COLOR, CardRarity.UNCOMMON, CardTarget.SELF);
