...
public class Fearless_Of_Death extends CustomCard {
    ...
    public Fearless_Of_Death() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Fearless_Of_Death.png", 2, cardStrings.DESCRIPTION, CardType.POWER, AbstractCardEnum.Chtho_COLOR, CardRarity.UNCOMMON, CardTarget.SELF);
