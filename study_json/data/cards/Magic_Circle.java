...
public class Magic_Circle extends CustomCard {
    ...
    public Magic_Circle() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Magic_Circle.png", 2, cardStrings.DESCRIPTION, CardType.ATTACK, AbstractCardEnum.Chtho_COLOR, CardRarity.UNCOMMON, CardTarget.ENEMY);
        this.baseDamage = 12;
