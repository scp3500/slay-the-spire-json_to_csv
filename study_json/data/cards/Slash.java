...
public class Slash extends CustomCard {
    ...
    public Slash() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Slash.png", 1, cardStrings.DESCRIPTION, CardType.ATTACK, AbstractCardEnum.Chtho_COLOR, CardRarity.UNCOMMON, CardTarget.ENEMY);
        this.baseDamage = 5;
