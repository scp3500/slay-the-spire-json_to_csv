...
public class Magic_Boundless extends CustomCard {
    ...
    public Magic_Boundless() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Magic_Boundless.png", 1, cardStrings.DESCRIPTION, CardType.ATTACK, AbstractCardEnum.Chtho_COLOR, CardRarity.UNCOMMON, CardTarget.SELF_AND_ENEMY);
        this.baseDamage = 7;
