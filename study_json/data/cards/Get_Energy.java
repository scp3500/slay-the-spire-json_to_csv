...
public class Get_Energy extends CustomCard {
    ...
    public Get_Energy() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Get_Energy.png", 0, cardStrings.DESCRIPTION, CardType.SKILL, AbstractCardEnum.Chtho_COLOR, CardRarity.UNCOMMON, CardTarget.SELF);
