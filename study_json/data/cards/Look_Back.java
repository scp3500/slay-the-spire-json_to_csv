...
public class Look_Back extends CustomCard {
    ...
    public Look_Back() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Look_Back.png", 0, cardStrings.DESCRIPTION, CardType.SKILL, AbstractCardEnum.Chtho_COLOR, CardRarity.RARE, CardTarget.SELF);
