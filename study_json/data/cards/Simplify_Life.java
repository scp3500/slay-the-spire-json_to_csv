...
public class Simplify_Life extends CustomCard {
    ...
    public Simplify_Life() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Simplify_Life.png", 1, cardStrings.DESCRIPTION, CardType.SKILL, AbstractCardEnum.Chtho_COLOR, CardRarity.COMMON, CardTarget.SELF);
