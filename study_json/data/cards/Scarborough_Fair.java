...
public class Scarborough_Fair extends CustomCard {
    ...
    public Scarborough_Fair() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Scarborough_Fair.png", 2, cardStrings.DESCRIPTION, CardType.SKILL, AbstractCardEnum.Chtho_COLOR, CardRarity.UNCOMMON, CardTarget.SELF);
