...
public class illusion_Body extends CustomCard {
    ...
    public illusion_Body() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/illusion_Body.png", 2, cardStrings.DESCRIPTION, CardType.SKILL, AbstractCardEnum.Chtho_COLOR, CardRarity.UNCOMMON, CardTarget.SELF);
