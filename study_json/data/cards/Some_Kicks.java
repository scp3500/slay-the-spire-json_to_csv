...
public class Some_Kicks extends CustomCard {
    ...
    public Some_Kicks() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Some_Kicks.png", -1, cardStrings.DESCRIPTION, CardType.ATTACK, AbstractCardEnum.Chtho_COLOR, CardRarity.UNCOMMON, CardTarget.ALL_ENEMY);
        this.baseDamage = 9;
    }
