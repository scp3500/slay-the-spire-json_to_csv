...
public class Parsley_N extends CustomCard {
    ...
    public Parsley_N() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Parsley_N.png", 1, cardStrings.DESCRIPTION, CardType.SKILL, AbstractCardEnum.Chtho_COLOR, CardRarity.UNCOMMON, CardTarget.SELF);
