...
public class Adjust_Sword extends CustomCard {
    ...
    public Adjust_Sword() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Adjust_Sword.png", 0, cardStrings.DESCRIPTION, CardType.POWER, AbstractCardEnum.Chtho_COLOR, CardRarity.RARE, CardTarget.SELF);
