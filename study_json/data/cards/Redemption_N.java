...
public class Redemption_N extends CustomCard {
    ...
    public Redemption_N() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Redemption_N.png", 1, cardStrings.DESCRIPTION, CardType.SKILL, AbstractCardEnum.Chtho_COLOR, CardRarity.UNCOMMON, CardTarget.SELF);
