...
public class Magic_Cover extends CustomCard {
    ...
    public Magic_Cover() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Magic_Cover.png", 2, cardStrings.DESCRIPTION, CardType.SKILL, AbstractCardEnum.Chtho_COLOR, CardRarity.RARE, CardTarget.SELF);
