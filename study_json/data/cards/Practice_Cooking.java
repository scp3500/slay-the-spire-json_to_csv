...
public class Practice_Cooking extends CustomCard {
    ...
    public Practice_Cooking() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Practice_Cooking.png", 2, cardStrings.DESCRIPTION, CardType.SKILL, AbstractCardEnum.Chtho_COLOR, CardRarity.UNCOMMON, CardTarget.SELF);
        this.misc = 4;
