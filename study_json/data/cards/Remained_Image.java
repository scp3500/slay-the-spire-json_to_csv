...
public class Remained_Image extends CustomCard {
    ...
    public Remained_Image() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Remained_Image.png", 1, cardStrings.DESCRIPTION, CardType.ATTACK, AbstractCardEnum.Chtho_COLOR, CardRarity.UNCOMMON, CardTarget.ENEMY);
        this.baseDamage = 7;
    }
