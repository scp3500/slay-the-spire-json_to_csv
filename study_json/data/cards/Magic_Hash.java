...
public class Magic_Hash extends CustomCard {
    ...
    public Magic_Hash() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Magic_Hash.png", 1, cardStrings.DESCRIPTION, CardType.ATTACK, AbstractCardEnum.Chtho_COLOR, CardRarity.COMMON, CardTarget.ENEMY);
        this.baseDamage = 3;
