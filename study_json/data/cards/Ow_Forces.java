...
public class Ow_Forces extends CustomCard {
    ...
    public Ow_Forces() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Ow_Forces.png", 1, cardStrings.DESCRIPTION, CardType.SKILL, AbstractCardEnum.Chtho_COLOR, CardRarity.UNCOMMON, CardTarget.SELF);
