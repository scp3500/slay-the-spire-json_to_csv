...
public class Magic_Illusion extends CustomCard {
    ...
    public Magic_Illusion() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Magic_Illusion.png", 1, cardStrings.DESCRIPTION, CardType.ATTACK, AbstractCardEnum.Chtho_COLOR, CardRarity.UNCOMMON, CardTarget.ENEMY);
        this.baseDamage = 2;
