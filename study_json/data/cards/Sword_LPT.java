...
public class Sword_LPT extends CustomCard {
    ...
    public Sword_LPT() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Sword_LPT.png", 2, cardStrings.DESCRIPTION, CardType.POWER, AbstractCardEnum.Chtho_COLOR, CardRarity.UNCOMMON, CardTarget.SELF);
