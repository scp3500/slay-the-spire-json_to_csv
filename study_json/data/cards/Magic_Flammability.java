...
public class Magic_Flammability extends CustomCard {
    ...
    public Magic_Flammability() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Magic_Flammability.png", 1, cardStrings.DESCRIPTION, CardType.ATTACK, AbstractCardEnum.Chtho_COLOR, CardRarity.COMMON, CardTarget.ENEMY);
        this.baseDamage = 8;
