...
public class Magic_Overflow extends CustomCard {
    ...
    public Magic_Overflow() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Magic_Overflow.png", 0, cardStrings.DESCRIPTION, CardType.SKILL, AbstractCardEnum.Chtho_COLOR, CardRarity.RARE, CardTarget.SELF);
