...
public class Flying_Slash extends CustomCard {
    ...
    public Flying_Slash() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Flying_Slash.png", 1, cardStrings.DESCRIPTION, CardType.ATTACK, AbstractCardEnum.Chtho_COLOR, CardRarity.COMMON, CardTarget.SELF_AND_ENEMY);
        this.baseDamage = 4;
        this.baseBlock = 4;
