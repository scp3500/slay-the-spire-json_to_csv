...
public class Magic_Fire extends CustomCard {
    ...
    public Magic_Fire(int upgrades) {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Magic_Fire.png", 1, cardStrings.DESCRIPTION, CardType.ATTACK, AbstractCardEnum.Chtho_COLOR, CardRarity.UNCOMMON, CardTarget.SELF_AND_ENEMY);
        this.baseDamage = 7;
