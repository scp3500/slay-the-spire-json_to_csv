...
public class Tenacity_N extends CustomCard {
    ...
    public Tenacity_N() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Tenacity_N.png", 1, cardStrings.DESCRIPTION, CardType.ATTACK, AbstractCardEnum.Chtho_COLOR, CardRarity.COMMON, CardTarget.ALL_ENEMY);
        this.baseDamage = 15;
