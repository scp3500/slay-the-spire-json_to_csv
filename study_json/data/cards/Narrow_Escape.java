...
public class Narrow_Escape extends CustomCard {
    ...
    public Narrow_Escape() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Narrow_Escape.png", 1, cardStrings.DESCRIPTION, CardType.SKILL, AbstractCardEnum.Chtho_COLOR, CardRarity.COMMON, CardTarget.SELF);
        this.baseBlock = 12;
