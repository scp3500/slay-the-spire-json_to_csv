...
public class Wings_Of_Fairy extends CustomCard {
    ...
    public Wings_Of_Fairy() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Wings_Of_Fairy.png", 2, cardStrings.DESCRIPTION, CardType.POWER, AbstractCardEnum.Chtho_COLOR, CardRarity.UNCOMMON, CardTarget.SELF);
