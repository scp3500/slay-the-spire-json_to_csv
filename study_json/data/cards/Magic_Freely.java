...
public class Magic_Freely extends CustomCard {
    ...
    public Magic_Freely() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Magic_Freely.png", 0, cardStrings.DESCRIPTION, CardType.SKILL, AbstractCardEnum.Chtho_COLOR, CardRarity.UNCOMMON, CardTarget.ENEMY);
