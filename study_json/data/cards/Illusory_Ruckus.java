...
public class Illusory_Ruckus extends CustomCard {
    ...
    public Illusory_Ruckus() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Illusory_Ruckus.png", 3, cardStrings.DESCRIPTION, CardType.POWER, AbstractCardEnum.Chtho_COLOR, CardRarity.RARE, CardTarget.SELF);
