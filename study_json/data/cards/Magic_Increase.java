...
public class Magic_Increase extends CustomCard {
    ...
    public Magic_Increase() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Magic_Increase.png", 2, cardStrings.DESCRIPTION, CardType.POWER, AbstractCardEnum.Chtho_COLOR, CardRarity.RARE, CardTarget.SELF);
