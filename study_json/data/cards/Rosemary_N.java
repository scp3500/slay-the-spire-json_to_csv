...
public class Rosemary_N extends CustomCard {
    ...
    public Rosemary_N() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Rosemary_N.png", 1, cardStrings.DESCRIPTION, CardType.SKILL, AbstractCardEnum.Chtho_COLOR, CardRarity.UNCOMMON, CardTarget.SELF);
