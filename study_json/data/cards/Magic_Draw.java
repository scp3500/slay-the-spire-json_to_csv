...
public class Magic_Draw extends CustomCard {
    ...
    public Magic_Draw() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Magic_Draw.png", 2, cardStrings.DESCRIPTION, CardType.ATTACK, AbstractCardEnum.Chtho_COLOR, CardRarity.RARE, CardTarget.ENEMY);
        this.baseDamage = 14;
