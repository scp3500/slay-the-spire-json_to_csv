...
public class Hone_N extends CustomCard {
    ...
    public Hone_N() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Hone_N.png", 1, cardStrings.DESCRIPTION, CardType.ATTACK, AbstractCardEnum.Chtho_COLOR, CardRarity.COMMON, CardTarget.SELF_AND_ENEMY);
        this.baseDamage = 9;
