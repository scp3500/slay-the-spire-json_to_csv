...
public class Experience_N extends CustomCard {
    ...
    public Experience_N() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Experience_N.png", 2, cardStrings.DESCRIPTION, CardType.SKILL, AbstractCardEnum.Chtho_COLOR, CardRarity.RARE, CardTarget.SELF);
