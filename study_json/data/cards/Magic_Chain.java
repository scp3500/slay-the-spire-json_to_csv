...
public class Magic_Chain extends CustomCard {
    ...
    public Magic_Chain() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Magic_Chain.png", 1, cardStrings.DESCRIPTION, CardType.POWER, AbstractCardEnum.Chtho_COLOR, CardRarity.UNCOMMON, CardTarget.SELF);
