...
public class Remember_N extends CustomCard {
    ...
    public Remember_N() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Remember_N.png", 1, cardStrings.DESCRIPTION, CardType.SKILL, AbstractCardEnum.Chtho_COLOR, CardRarity.UNCOMMON, CardTarget.SELF);
