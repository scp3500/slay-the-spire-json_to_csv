...
public class Reminiscing_Past extends CustomCard {
    ...
    public Reminiscing_Past() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Reminiscing_Past.png", 1, cardStrings.DESCRIPTION, CardType.ATTACK, AbstractCardEnum.Chtho_COLOR, CardRarity.COMMON, CardTarget.SELF_AND_ENEMY);
        this.baseDamage = 10;
