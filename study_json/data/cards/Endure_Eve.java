...
public class Endure_Eve extends CustomCard {
    ...
    public Endure_Eve() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Endure_Eve.png", 1, cardStrings.DESCRIPTION, CardType.ATTACK, AbstractCardEnum.Chtho_COLOR, CardRarity.UNCOMMON, CardTarget.ALL_ENEMY);
        this.baseDamage = 6;
