...
public class The_Last_Bullets extends CustomCard {
    ...
    public The_Last_Bullets() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/The_Last_Bullets.png", 1, cardStrings.DESCRIPTION, CardType.ATTACK, AbstractCardEnum.Chtho_COLOR, CardRarity.RARE, CardTarget.ENEMY);
        this.baseDamage = 4;
