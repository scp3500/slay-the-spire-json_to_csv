...
public class More_Amazonian extends CustomCard {
    ...
    public More_Amazonian() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/More_Amazonian.png", 2, cardStrings.DESCRIPTION, CardType.ATTACK, AbstractCardEnum.Chtho_COLOR, CardRarity.UNCOMMON, CardTarget.ENEMY);
        this.baseDamage = 7;
