...
public class Many_Lives extends CustomCard {
    ...
    public Many_Lives() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Many_Lives.png", 1, cardStrings.DESCRIPTION, CardType.POWER, AbstractCardEnum.Chtho_COLOR, CardRarity.UNCOMMON, CardTarget.SELF);
