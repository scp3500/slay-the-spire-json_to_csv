...
import power.MyLoseStrengthPower;
...
public class Butter_Cake extends CustomCard {
    ...
    public Butter_Cake() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Butter_Cake.png", 1, cardStrings.DESCRIPTION, CardType.SKILL, AbstractCardEnum.Chtho_COLOR, CardRarity.UNCOMMON, CardTarget.SELF);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        if (p.hasPower("Strength")) {
            ...
            this.addToTop(new ApplyPowerAction(p, p, new MyLoseStrengthPower(p, strAmt), strAmt));
        }
