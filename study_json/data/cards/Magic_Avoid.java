...
public class Magic_Avoid extends CustomCard {
    ...
    public Magic_Avoid() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Magic_Avoid.png", 2, cardStrings.DESCRIPTION, CardType.SKILL, AbstractCardEnum.Chtho_COLOR, CardRarity.UNCOMMON, CardTarget.SELF);
        this.baseBlock = 10;
