...
public class Memory_Erosion extends CustomCard {
    ...
    public Memory_Erosion() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Memory_Erosion.png", 1, cardStrings.DESCRIPTION, CardType.SKILL, AbstractCardEnum.Chtho_COLOR, CardRarity.RARE, CardTarget.ENEMY);
