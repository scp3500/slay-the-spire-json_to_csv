...
public class Fight_Battle extends CustomCard {
    ...
    public Fight_Battle() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Fight_Battle.png", 2, cardStrings.DESCRIPTION, CardType.ATTACK, AbstractCardEnum.Chtho_COLOR, CardRarity.COMMON, CardTarget.SELF_AND_ENEMY);
        this.baseDamage = 17;
