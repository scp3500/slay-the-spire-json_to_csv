...
public class Concern_N extends CustomCard {
    ...
    public Concern_N() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Concern_N.png", 1, cardStrings.DESCRIPTION, CardType.SKILL, AbstractCardEnum.Chtho_COLOR, CardRarity.COMMON, CardTarget.SELF);
