...
public class Chop_Of_Death extends CustomCard {
    ...
    public Chop_Of_Death() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Chop_Of_Death.png", 2, cardStrings.DESCRIPTION, CardType.ATTACK, AbstractCardEnum.Chtho_COLOR, CardRarity.COMMON, CardTarget.SELF_AND_ENEMY);
        this.baseDamage = 15;
