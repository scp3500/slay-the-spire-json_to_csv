...
public class Alert_N extends CustomCard {
    ...
    public Alert_N() {
        super(ID, cardStrings.NAME, "img/cards_Chtholly/Alert_N.png", 1, cardStrings.DESCRIPTION, CardType.ATTACK, AbstractCardEnum.Chtho_COLOR, CardRarity.RARE, CardTarget.ENEMY);
        this.baseDamage = 2;
